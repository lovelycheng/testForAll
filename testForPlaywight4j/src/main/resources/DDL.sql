...
WHERE TABLE_NAME = upper('EASYFLOW_FLOW_DETAIL_REC')
  AND COLUMN_NAME = upper('NO_LOG_NODE');
IF N = 0 THEN
        BEGIN
            EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV"."EASYFLOW_FLOW_DETAIL_REC" ADD "NO_LOG_NODE" NCLOB NULL';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN "EASYFLOW_3052TJBHDEV"."EASYFLOW_FLOW_DETAIL_REC"."NO_LOG_NODE" IS ''不打印日志流程组件 SRCID 列表''';
commit;
END;
END IF;
END;
...
FROM USER_TAB_COLUMNS
WHERE TABLE_NAME = upper('EASYFLOW_FLOW_DETAIL_REC')
  AND COLUMN_NAME = upper('NO_LOG_VAR');
IF N = 0 THEN
        BEGIN
            EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV"."EASYFLOW_FLOW_DETAIL_REC" ADD "NO_LOG_VAR" NCLOB NULL';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN "EASYFLOW_3052TJBHDEV"."EASYFLOW_FLOW_DETAIL_REC"."NO_LOG_VAR" IS ''不打印日志流程组件 SRCID 列表''';
commit;
END;
END IF;
END;
...
SELECT COUNT(1) INTO N
FROM USER_TAB_COLUMNS
WHERE TABLE_NAME = upper('EASYFLOW_FLOW_ENV_RELATION')
  AND COLUMN_NAME = upper('LOG_LEVEL');
IF N = 0 THEN
        BEGIN
            EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV"."EASYFLOW_FLOW_ENV_RELATION" ADD "LOG_LEVEL" NVARCHAR2(5) NULL';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN "EASYFLOW_3052TJBHDEV"."EASYFLOW_FLOW_ENV_RELATION"."LOG_LEVEL" IS ''流程日志级别 TRACE,DEBUG,INFO,WARN,ERROR''';
commit;
END;
END IF;
END;
...
SELECT COUNT(1) INTO N
FROM USER_TAB_COLUMNS
WHERE TABLE_NAME = upper('EASYFLOW_API_ROUTE_CONFIG')
  AND COLUMN_NAME = upper('API_BIZ_TYPE');
IF N = 0 THEN
        BEGIN
            EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV"."EASYFLOW_API_ROUTE_CONFIG"
    ADD "API_BIZ_TYPE" NVARCHAR2(2) DEFAULT ''01''';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN "EASYFLOW_3052TJBHDEV"."EASYFLOW_API_ROUTE_CONFIG"."API_BIZ_TYPE" IS ''01 表示交易接口,02 表示查询接口''';
commit;
END;
END IF;
END;
...
FROM USER_TAB_COLUMNS
WHERE TABLE_NAME = upper('EASYFLOW_FLOW_ENV_RELATION')
  AND COLUMN_NAME = upper('FLOW_INSTANCE_CLEAR_TIME');
IF N = 0 THEN
        BEGIN
            EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV".EASYFLOW_FLOW_ENV_RELATION ADD ' ||
'FLOW_INSTANCE_CLEAR_TIME NUMBER(20) NULL';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN "EASYFLOW_3052TJBHDEV".EASYFLOW_FLOW_ENV_RELATION.FLOW_INSTANCE_CLEAR_TIME IS ''实例清理时间,单位秒''';
commit;
END;
END IF;
END;
...
SELECT COUNT(1) INTO N
FROM USER_TAB_COLUMNS
WHERE TABLE_NAME = upper('EASYFLOW_FLOW_DEFINE')
  AND COLUMN_NAME = upper('BIZ_TYPE');
IF N = 0 THEN
        BEGIN
            EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV".EASYFLOW_FLOW_DEFINE
    ADD BIZ_TYPE CHAR(2) NULL';
EXECUTE IMMEDIATE 'COMMENT ON COLUMN "EASYFLOW_3052TJBHDEV".EASYFLOW_FLOW_DEFINE.BIZ_TYPE IS ''业务类型 BizType(01-交易, 02-查询)''';
commit;
END;
END IF;
END;
...
SELECT COUNT(1) INTO N
FROM USER_TAB_COLUMNS
WHERE TABLE_NAME = upper('EASYFLOW_ENV')
  AND COLUMN_NAME = upper('PROJECT_CODE')
  and NULLABLE = 'N';
IF N = 0 THEN
        BEGIN
            EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV".EASYFLOW_ENV
    MODIFY
...
FROM USER_TAB_COLUMNS
WHERE TABLE_NAME = upper('EASYFLOW_ENV')
  AND COLUMN_NAME = upper('CLUSTER_ID')
  and NULLABLE = 'N';
IF N = 0 THEN
        BEGIN
            EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV".EASYFLOW_ENV
...
WHERE TABLE_NAME = 'EASYFLOW_ENV'
  AND CONSTRAINT_NAME = 'UK_EE_PC';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE "EASYFLOW_3052TJBHDEV".EASYFLOW_ENV ADD CONSTRAINT UK_EE_PC UNIQUE (PROJECT_CODE, CLUSTER_ID)';
commit;
END;
END IF;
END;
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_FLUX_RULE'
  AND CONSTRAINT_NAME = 'PK_EFR_FLUXRULEID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_FLUX_RULE
...
FROM all_indexes
WHERE TABLE_NAME = 'EASYFLOW_FLUX_RULE'
  and INDEX_NAME = 'UK_EFR_FGPP_D';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX EASYFLOW_3052TJBHDEV."UK_EFR_FGPP_D"
    ON EASYFLOW_3052TJBHDEV.EASYFLOW_FLUX_RULE ("FLUX_GROUP_ID" ASC, "PARAMETER_TYPE" ASC, "PARAMETER_NAME" ASC,
                                                "DELETED" ASC) TABLESPACE BASE';
commit;
END;
END IF;
END;
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_JAR_FILE'
  AND CONSTRAINT_NAME = 'PK_EJF_JARFILEID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_JAR_FILE
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RELEASE_PLAN'
  AND CONSTRAINT_NAME = 'PK_ERP_PLANID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RELEASE_PLAN
...
FROM all_indexes
WHERE TABLE_NAME = 'EASYFLOW_RELEASE_PLAN'
  and INDEX_NAME = 'UK_ERP_PP_D';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX EASYFLOW_3052TJBHDEV."UK_ERP_PP_D"
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RELEASE_PLAN_FLOW'
  AND CONSTRAINT_NAME = 'PK_ERPF_PLANFLOWID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RELEASE_PLAN_FLOW
...
FROM all_indexes
WHERE TABLE_NAME = 'EASYFLOW_RELEASE_PLAN_FLOW'
  and INDEX_NAME = 'UK_ERPF_PPFF_D';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX EASYFLOW_3052TJBHDEV."UK_ERPF_PPFF_D"
    ON EASYFLOW_3052TJBHDEV.EASYFLOW_RELEASE_PLAN_FLOW ("PLAN_ID" ASC, "PROJECT_CODE" ASC, "FLOW_CODE" ASC,
                                                        "FLOW_VERSION" ASC, "DELETED" ASC) TABLESPACE BASE';
commit;
END;
END IF;
END;
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RELEASE_UPGRADE'
  AND CONSTRAINT_NAME = 'PK_ERU_UPGRADEID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RELEASE_UPGRADE
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RELEASE_UPGRADE_LOG'
  AND CONSTRAINT_NAME = 'PK_ERUL_LOGID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RELEASE_UPGRADE_LOG
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RP_BAK_API'
  AND CONSTRAINT_NAME = 'PK_ERBA_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RP_BAK_API
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RP_BAK_COMPONENT'
  AND CONSTRAINT_NAME = 'PK_ERBC_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RP_BAK_COMPONENT
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RP_BAK_FLOW'
  AND CONSTRAINT_NAME = 'PK_ERBF_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RP_BAK_FLOW
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RP_BAK_FLOW_DD'
  AND CONSTRAINT_NAME = 'PK_ERBFD_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RP_BAK_FLOW_DD
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RP_BAK_FLOW_DEPLOY'
  AND CONSTRAINT_NAME = 'PK_ERBFD_DEPLOY_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RP_BAK_FLOW_DEPLOY
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RP_BAK_FLOW_RC'
  AND CONSTRAINT_NAME = 'PK_ERBFR_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RP_BAK_FLOW_RC
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RP_BAK_FUNCTION'
  AND CONSTRAINT_NAME = 'PK_ERBF_FUNCTION_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RP_BAK_FUNCTION
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RP_BAK_RULE'
  AND CONSTRAINT_NAME = 'PK_ERBR_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RP_BAK_RULE
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_RPC_COMP_TEMPLATE'
  AND CONSTRAINT_NAME = 'PK_ERCT_ID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_RPC_COMP_TEMPLATE
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_SERVICE_INFO'
  AND CONSTRAINT_NAME = 'PK_ESI_SERVICEINFOID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_SERVICE_INFO
...
FROM all_indexes
WHERE TABLE_NAME = 'EASYFLOW_SERVICE_INFO'
  and INDEX_NAME = 'SERVICE_NAME_VERSION_DELETED';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX EASYFLOW_3052TJBHDEV."SERVICE_NAME_VERSION_DELETED"
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_SERVICE_VERSION'
  AND CONSTRAINT_NAME = 'PK_ESV_SERVICEVERSIONID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_SERVICE_VERSION
...
FROM all_indexes
WHERE TABLE_NAME = 'EASYFLOW_SERVICE_VERSION'
  and INDEX_NAME = 'UK_ESV_PECSS_D';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX EASYFLOW_3052TJBHDEV."UK_ESV_PECSS_D"
    ON EASYFLOW_3052TJBHDEV.EASYFLOW_SERVICE_VERSION ("PROJECT_CODE" ASC, "ENV_CODE" ASC, "CLUSTER_ID" ASC,
                                                      "SERVICE_NAME" ASC, "SERVICE_VERSION" ASC, "DELETED"
                                                      ASC) TABLESPACE BASE';
commit;
END;
END IF;
...
FROM user_constraints
WHERE TABLE_NAME = 'EASYFLOW_SHUTDOWN_LOG'
  AND CONSTRAINT_NAME = 'PK_ESL_LOGID_TNTID';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'ALTER TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_SHUTDOWN_LOG
...
SELECT count(*) INTO N
FROM all_indexes
WHERE TABLE_NAME = 'EASYFLOW_PROJECT_USER_ROLE_REL'
  and INDEX_NAME = 'UK_EPURR_PUR';
IF
		N = 0 THEN
		BEGIN
			EXECUTE IMMEDIATE 'CREATE UNIQUE INDEX UK_EPURR_PUR ON "EASYFLOW_3052TJBHDEV".EASYFLOW_PROJECT_USER_ROLE_REL (PROJECT_CODE, USER_ID,
                                                                                           ROLE_ID)';
commit;
END;
END IF;
...
COMMENT ON TABLE EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO IS '标签信息表';
COMMENT ON COLUMN EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO.TAG_ID IS '主键,;tagLevel.tagName';
COMMENT ON COLUMN EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO.TAG_NAME IS '标签名称';
COMMENT ON COLUMN EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO.TAG_LEVEL IS '标签级别';
COMMENT ON COLUMN EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO.PROJECT_CODE IS '项目编码;可空';
COMMENT ON COLUMN EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO.DIRECTORY_ID IS '目录ID;可空';
COMMENT ON COLUMN EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO.PARENT_ID IS '父级标签ID';
COMMENT ON COLUMN EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO.CREATE_TIME IS '创建时间';
COMMENT ON COLUMN EASYFLOW_3052TJBHDEV.EASYFLOW_TAG_INFO.UPDATE_TIME IS '修改时间';
