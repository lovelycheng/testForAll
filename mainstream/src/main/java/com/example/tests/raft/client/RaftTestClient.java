...
import com.example.tests.raft.server.ServerHandler;
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        try {
            ...
            ChannelFuture channelFuture = bootstrap.connect("127.0.0.1", 6699)
                .sync();
            channelFuture.channel().writeAndFlush(new Packet(1,11,new Object())).addListener(new GenericFutureListener<Future<? super Void>>() {
                @Override
